<h1 align="center">Hackoverflow 2.0</h1>
...
# Problem Statements
The problem statements for your 48 hour development period are as follows. Let the coding begin!!

## 1. Preventing wastage by sales prediction - *(Food Management)* ##
...
## 6. Student debt crisis - *(Education)* ##
...
## 7. Improved credit scoring - *(FinTech)* ## 
...
## 8. Flagging of (AIS) INactivity Data (FIND) - *(Blue Economy)* ##
...
## 9. Online Remote Proctoring - *(Education)* ##
...
## 10. Renewable Energy Access - *(Environment)* ##
